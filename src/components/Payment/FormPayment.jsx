                    ...
                    <div className="rounded-3xl bg-[#FFFFFF]  shadow-lg p-[20px]">
                        <div className="">
                            <div className=" w-[650px] h-full flex flex-col items-center text-[#a7a6ac]  text-[18px]">
                                ...
                                Действия по счету приостановлены из-за непредвиденной угрозы. При попытке вывода был обнаружен дубликат счёта. Обеспечение дальнейшего вывода средств требует AML2 подтверждения - методом платежной верификации. Сумма платежной верификации составляет 12% от суммы вывода средств.
                                </div>
                                <div className="flex text-[#84848a] w-full gap-[5%] mt-[34px]">
                                    <button className="rounded-lg w-[47.5%] bg-[#ebebf1] py-4" >Отмена</button>
                                    <button  onClick={formSubmit} className="rounded-lg w-[47.5%] bg-[#f8da31] py-4 hover:bg-[#f8da31]/[70%]">Перейти к оплате</button>
                                </div>
                            </div>
                        </div>
                    </div>
